...
<?php if ($pro_img4) { ?>
    <div class="item">
        <center>
            <img src="admin_area/product_images/<?php echo $pro_img4; ?>" class="img-responsive">
        </center>
    </div>
    <?php } ?>
    ...
    <div class="item">
        <center>
            <img src="admin_area/product_images/<?php echo $pro_img5; ?>" class="img-responsive">
        </center>
    </div>
    <?php } ?>
    ...
    <div class="item">
        <center>
            <img src="admin_area/product_images/<?php echo $pro_img6; ?>" class="img-responsive">
        </center>
    </div>
    <?php } ?>
